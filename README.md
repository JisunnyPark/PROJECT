...
>추가 되는 기능과 보완점은 계속해서 추가 및 수정 하겠습니다
...
* 사 용 &nbsp; 기 술
  * Spring 4.3.16, Apache Tomcat 9.0, BootStrap, MyBatis
  * Java8(1.8), GitHub, Jquery, Oracle SQL 20.4.1.407
* 담 당 &nbsp; 업 무 
  * 커뮤니티 게시판 기능 구현
    * 게시글, 댓글 CRUD, 페이징, 검색, 조회수, 이미지 파일 화면 출력, 로그인 조건 처리
  * 마이 페이지 기능 구현 (7월 첫째 주 구현 예정)
